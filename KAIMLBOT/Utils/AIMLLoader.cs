...
namespace KAIMLBot.Utils
{
    ...
    public class AIMLLoader
    {
        ...
        public AIMLLoader(KAIMLBot.Bot bot)
        {
            this.bot = bot;
        }
        ...
        public string Normalize(string input, bool isUserInput)
        {
            ...
            Normalize.ApplySubstitutions substitutor = new KAIMLBot.Normalize.ApplySubstitutions(this.bot);
            Normalize.StripIllegalCharacters stripper = new KAIMLBot.Normalize.StripIllegalCharacters(this.bot);

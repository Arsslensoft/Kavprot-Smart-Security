...
namespace KAIMLBot.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person2 : KAIMLBot.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public person2(KAIMLBot.Bot bot,
                        KAIMLBot.User user,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person2")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return KAIMLBot.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.Person2Substitutions, this.templateNode.InnerText);
                }
                else
                {

...
namespace KAIMLBot.AIMLTagHandlers
{
    ...
    /// </summary>
    public class gender : KAIMLBot.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public gender(KAIMLBot.Bot bot,
                        KAIMLBot.User user,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "gender")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return KAIMLBot.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.GenderSubstitutions, this.templateNode.InnerText);
                }
                else
                {

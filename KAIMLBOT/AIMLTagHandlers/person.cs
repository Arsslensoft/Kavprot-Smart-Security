...
namespace KAIMLBot.AIMLTagHandlers
{
    ...
    /// </summary>
    public class person : KAIMLBot.Utils.AIMLTagHandler
    {
        /// <summary>
        /// Ctor
        /// </summary>
        ...
        public person(KAIMLBot.Bot bot,
                        KAIMLBot.User user,
        ...
        protected override string ProcessChange()
        {
            if (this.templateNode.Name.ToLower() == "person")
            {
                if (this.templateNode.InnerText.Length > 0)
                {
                    ...
                    return KAIMLBot.Normalize.ApplySubstitutions.Substitute(this.bot, this.bot.PersonSubstitutions, this.templateNode.InnerText);
                }
                else
                {

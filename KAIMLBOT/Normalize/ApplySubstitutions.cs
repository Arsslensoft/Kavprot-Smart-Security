...
namespace KAIMLBot.Normalize
{
    ...
    /// </summary>
    public class ApplySubstitutions : KAIMLBot.Utils.TextTransformer
    {
        public ApplySubstitutions(KAIMLBot.Bot bot, string inputString)
            : base(bot, inputString)
        { }

        public ApplySubstitutions(KAIMLBot.Bot bot)
            : base(bot)
        { }

...
namespace KAIMLBot
{
    ...
    public class Bot
    {
        ...
        /// </summary>
        public KAIMLBot.Utils.Node Graphmaster;
        ...
        private void setup()
        {
            ...
            this.Graphmaster = new KAIMLBot.Utils.Node(); 
        }
        ...
        public void loadSettings(string pathToSettings)
        {
            ...
            {
                this.GlobalSettings.addSetting("website", "http://sourceforge.net/projects/KAIMLBot");
            }
        ...
        public Result Chat(Request request)
        {
            ...
            if (this.isAcceptingUserInput)
            {
                // Normalize the input
                AIMLLoader loader = new AIMLLoader(this);
                KAIMLBot.Normalize.SplitIntoSentences splitter = new KAIMLBot.Normalize.SplitIntoSentences(this);
                ...
                if (object.Equals(null, tagHandler))
                {
                    switch (tagName)
                    {
                        ...
                        case "get":
                            ...
                            break;
                        case "wiki":
                            tagHandler = new AIMLTagHandlers.wiki(this, user, query, request, result, node);
                            break;
                        case "direct":
                            tagHandler = new AIMLTagHandlers.direct(this, user, query, request, result, node);
                            break;
                        case "gossip":
                        ...
                        case "person":
                            ...
                            break;
                        case "evalexpr":
                            tagHandler = new AIMLTagHandlers.evalexpr(this, user, query, request, result, node);
                            break;
                        case "person2":
        ...
        {
            MailMessage msg = new MailMessage("donotreply@KAIMLBot.com",this.AdminEmail);
            msg.Subject = "WARNING! KAIMLBot has encountered a problem...";

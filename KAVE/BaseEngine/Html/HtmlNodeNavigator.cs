// KavProtHtml V1.0 - Simon Mourier <simon underscore mourier at hotmail dot com>
using System;
...
namespace KavProtHtml
{
    ...
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        internal void InternalTrace(object traceValue)
        {
            ...
            KavProtHtml.Trace.WriteLine(string.Format("oid={0},n={1},a={2},v={3},{4}", GetHashCode(), nodename, _attindex, nodevalue, traceValue), "N!" + name);
        }

...
namespace KPCAP.AirPcap
{
    /// <summary>
    /// AirPcap device
    /// </summary>
    public class AirPcapDevice : KPCAP.WinPcap.WinPcapDevice
    {
        /// <summary>
        ...
        /// </summary>
        public override Kavprot.Packets.LinkLayers LinkType
        {
            get
            {
                var linkLayer = Kavprot.Packets.LinkLayers.Null;

                switch(AirPcapLinkType)
                {
                    case AirPcapLinkTypes._802_11_PLUS_RADIO:
                        linkLayer = Kavprot.Packets.LinkLayers.Ieee80211_Radio;
                        break;
                    case AirPcapLinkTypes._802_11:
                        linkLayer = Kavprot.Packets.LinkLayers.Ieee802;
                        break;
                    case AirPcapLinkTypes._802_11_PLUS_PPI:
                        linkLayer = Kavprot.Packets.LinkLayers.PerPacketInformation;
                        break;
                    default:
        ...
        protected override void CaptureThread()
        {
            ...
            List<Kavprot.Packets.RawPacket> packets;

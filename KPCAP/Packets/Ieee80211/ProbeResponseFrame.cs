...
namespace Kavprot.Packets
{
    namespace Ieee80211
    {
        ...
        public class ProbeResponseFrame : ManagementFrame
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="Kavprot.Packets.Ieee80211.ProbeResponseFrame"/> class.
            /// </summary>
                                       ...
                                       InformationElementList InformationElements)
            {
                ...
                this.FrameControl.SubType = Kavprot.Packets.Ieee80211.FrameControlField.FrameSubTypes.ManagementProbeResponse;
            }

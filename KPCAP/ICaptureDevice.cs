...
#region Dump related
        ...
        void Dump(Kavprot.Packets.RawPacket p);
        ...
        /// </summary>
        /// <returns></returns>
        Kavprot.Packets.RawPacket GetNextPacket();

        /// <summary>
        /// Sends a raw packet throgh this device
        /// </summary>
        /// <param name="p">The packet to send</param>
        void SendPacket(Kavprot.Packets.Packet p);
        ...
        void SendPacket(Kavprot.Packets.Packet p, int size);
        ...
        /// </summary>
        Kavprot.Packets.LinkLayers LinkType { get; }
    }
}

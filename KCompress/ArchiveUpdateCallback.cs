...
namespace KCompress
{
                                                  ...
                                                  IDisposable
    {
        ...
        private KCompressCompressor _compressor;
        ...
        public ArchiveUpdateCallback(
            ...
            KCompressCompressor compressor, UpdateData updateData, bool directoryStructure)
        {
        ...
        /// <param name="directoryStructure">Preserve directory structure.</param>
        public ArchiveUpdateCallback(
            Stream stream, KCompressCompressor compressor, UpdateData updateData, bool directoryStructure)
        {
        ...
        /// <param name="directoryStructure">Preserve directory structure.</param>
        public ArchiveUpdateCallback(
            Stream stream, string password, KCompressCompressor compressor, UpdateData updateData,
        ...
        private void CommonInit(KCompressCompressor compressor, UpdateData updateData, bool directoryStructure)
        {
        ...
        private void Init(
            FileInfo[] files, int rootLength, KCompressCompressor compressor,

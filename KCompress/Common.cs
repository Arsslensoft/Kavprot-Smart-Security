...
namespace KCompress
{
    ...
    /// <summary>
    /// KCompress Extractor/Compressor base class. Implements Password string, ReportErrors flag.
    /// </summary>
    public class KCompressBase : MarshalByRefObject
    {
        ...
        internal static void AsyncCallbackMethod(IAsyncResult ar) 
        {
            ...
            ((KCompressBase)ar.AsyncState).ReleaseContext();
        }
...
#endif
        /// <summary>
        /// Gets the unique identificator of this KCompressBase instance.
        /// </summary>
        public int UniqueID
        {
            get
        ...
        #region Constructors
        /// <summary>
        /// Initializes a new instance of the KCompressBase class.
        /// </summary>
        protected KCompressBase()
        {
            _password = "";
            _reportErrors = true;
        ...
        protected KCompressBase(string password)
        {
            if (String.IsNullOrEmpty(password))
            {
                throw new KCompressException("Empty password was specified.");
            }
            _password = password;
            _reportErrors = true;
            _uniqueID = GetUniqueID();
        ...
        internal void ThrowUserException()
        {
            if (HasExceptions)
            {
                throw new KCompressException(KCompressException.USER_EXCEPTION_MESSAGE);
            }
        }
                ...
                if (!handler.HasExceptions)
                {
                    if (hresult < -2000000000)
                    {
                        ThrowException(handler,
                                       new KCompressException(
                                           "The execution has failed due to the bug in the KCompressSharp.\n" +
                                           "Please report about it to http://KCompresssharp.codeplex.com/WorkItem/List.aspx, post the release number and attach the archive."));
                    }
                    else
                    {
                        ThrowException(handler,
                                       new KCompressException(message + hresult.ToString(CultureInfo.InvariantCulture) +
                                                             '.'));
                    }
                }
                else
        ...
        {
            KCompressLibraryManager.SetLibraryPath(libraryPath);
        }
#endif
        /// <summary>
        ...
        public static LibraryFeature CurrentLibraryFeatures
        {
            get
            {
                return KCompressLibraryManager.CurrentLibraryFeatures;
            }
        }

        /// <summary>
        /// Determines whether the specified System.Object is equal to the current KCompressBase.
        /// </summary>
        /// <param name="obj">The System.Object to compare with the current KCompressBase.</param>
        /// <returns>true if the specified System.Object is equal to the current KCompressBase; otherwise, false.</returns>
        public override bool Equals(object obj)
        {
            var inst = obj as KCompressBase;
            if (inst == null)
            {
                return false;
            }
        ...
        /// </summary>
        /// <returns> A hash code for the current KCompressBase.</returns>
        ...
        /// <summary>
        /// Returns a System.String that represents the current KCompressBase.
        /// </summary>
        /// <returns>A System.String that represents the current KCompressBase.</returns>
        public override string ToString()
        {
            var type = "KCompressBase";
            if (this is KCompressExtractor)
            {
                type = "KCompressExtractor";
            }
            if (this is KCompressCompressor)
            {
                type = "KCompressCompressor";
            }

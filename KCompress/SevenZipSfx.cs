...
namespace KCompress
{
    ...
    public class KCompressSfx
    {
        ...
        {
#if !WINCE
            return "KCompress.sfx." + str;
#else
            return "KCompressSharpMobile.sfx." + str;
#endif
        }
        ...
        private static SfxModule GetModuleByName(string name)
        {
            ...
            throw new KCompressSfxValidationException("The specified configuration is unsupported.");
        }

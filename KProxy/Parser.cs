    ...
    public class Parser
    {
        ...
        internal static bool ParseNVPHeaders(HTTPHeaders oHeaders, string[] sHeaderLines, int iStartAt, ref string sErrors)
        {
            ...
            while (index < sHeaderLines.Length)
            {
                ...
                {
                    //KProxyApplication.Log.LogString("[HTTPWarning] Header folding detected. Not all clients properly handle folded headers.");
        ...
        public static HTTPResponseHeaders ParseResponse(string sResponse)
        {
            ...
            if (index >= 1)
            {
                ...
                HTTPResponseHeaders oHeaders = new HTTPResponseHeaders(KPCONFIG.oHeaderEncoding);
